...
public class OI {
	...
	public OI() {
		...
		// SmartDashboard.putData("Move Elevator to Switch", new MoveElevator(MoveElevator.PreSetHeight.Switch));
		// SmartDashboard.putData("Move Elev To Scale", new MoveElevator(MoveElevator.PreSetHeight.Scale));
		SmartDashboard.putData("Time Elev2Scale", new TimedMoveElevator(3, 0.5));
